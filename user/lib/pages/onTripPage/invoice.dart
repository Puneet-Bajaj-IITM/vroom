                                                                                    ...
                                                                                    Column(
                                                                                      ...
                                                                                      children: [
                                                                                        Text(
                                                                                          ...
                                                                                          style: GoogleFonts.poppins(fontSize: media.width * fourteen, fontWeight: FontWeight.w600, color: textColor),
                                                                                        ),
                                                                                        Text(
                                                                                              ...
                                                                                              : (userRequestData['payment_type'].toString().split(',').toList()[i] == 'wallet')
                                                                                                  ...
                                                                                                  : (userRequestData['payment_type'].toString().split(',').toList()[i] == 'card')
                                                                                                      ...
                                                                                                      : (userRequestData['payment_type'].toString().split(',').toList()[i] == 'upi')
                                                                                                          ...
                                                                                                          : '',
                                                                                          style: GoogleFonts.poppins(fontSize: media.width * ten, color: textColor),
                                                                                        )
                                                                                      ],
                                                                                    ),
                                                                                    Expanded(
