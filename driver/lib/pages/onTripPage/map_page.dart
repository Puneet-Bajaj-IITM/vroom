                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Row(
                                                                                          ...
                                                                                          children: [
                                                                                            ...
                                                                                            Expanded(
                                                                                              child: MyText(
                                                                                                text: choosenRide[0]['drop_address'],
                                                                                                maxLines: 1,
                                                                                                size: media.width * twelve,
                                                                                              ),
                                                                                            ),
                                                                                                ...
                                                                                                onTap: () async {
                                                                                                  if (bidText.text.isNotEmpty || choosenRide[0]['price'] != null) {
                                                                                                    ...
                                                                                                    try {
                                                                                                      ...
                                                                                                      FirebaseDatabase.instance.ref().child('drivers/driver_driver_${userDetails['id']}').update({'is_available': false});
