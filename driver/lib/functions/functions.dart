...
//base url
String url = 'https://app.vroomgh.com/';
//add '/' at the end of the url as 'https://url.com/'
String mapkey = 'AIzaSyA8E0YMjuqsB02XCXl-3kCaK-cY2Ogn51g';
String mapStyle = '';
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "Vroom Driver will continue to receive your location in background",
